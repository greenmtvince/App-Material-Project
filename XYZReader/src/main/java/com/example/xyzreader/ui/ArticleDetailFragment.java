...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPhotoView = (ImageView) mRootView.findViewById(R.id.topImageView);
        ...
        /*getActivity().getWindow().getSharedElementEnterTransition().addListener(new Transition.TransitionListener() {
            ...
            public void onTransitionStart(Transition transition) {
                mPhotoView.animate().setDuration(500).alpha(1f);
            }
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            bodyView.setText(getString(R.string.ipsum_lorem));//Html.fromHtml(mCursor.getString(ArticleLoader.Query.BODY).replaceAll("(\r\n|\n)", "<br />")));
